<!-- app/Views/incoming_goods/index.php -->
<?= $this->extend('layout') ?>
    ...
    <div class="row">
        ...
        <div class="col-auto col-md-3 col-lg-2 px-0 bg-dark" id="sidebar">
            <div class="d-flex flex-column align-items-start text-white min-vh-100" id="sidebar-content">
                <a href="#" class="fs-4 py-3 ps-3 text-white text-decoration-none">WMS - Incoming Goods</a>
                <ul class="nav flex-column w-100">
                    ...
                    <li><a href="<?= base_url('/incoming_goods'); ?>" class="nav-link text-white px-3 active">Incoming</a></li>
        ...
        <div class="col py-3" id="main-content">
            ...
            <div class="d-flex justify-content-between align-items-center bg-light p-3 rounded mb-3 shadow-sm">
                ...
                <h4 class="m-0">Incoming Goods</h4>
                <div>
            ...
            <div class="container mt-4">
                ...
                <a href="<?= base_url('/incoming_goods/create'); ?>" class="btn btn-primary mb-3">Add New</a>
                <table class="table table-bordered table-hover mt-3">
                    ...
                    <tbody>
                        <?php foreach ($incomingGoods as $item): ?>
                        <tr>
                            <td><?= esc($item['date']) ?></td>
                            <td><?= esc($item['item_name']) ?></td>
                            <td><?= esc($item['quantity']) ?></td>
                            <td>
                                <a href="<?= base_url('/incoming_goods/edit/' . $item['id']); ?>" class="btn btn-warning btn-sm">Edit</a>
                                <a href="<?= base_url('/incoming_goods/delete/' . $item['id']); ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this item?')">Delete</a>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
